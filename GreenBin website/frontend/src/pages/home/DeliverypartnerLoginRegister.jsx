...
import wayConcept from "../../assets/way-concept-illustration.jpeg"; // Import the image
...
const DeliverypartnerLoginRegister = () => {
  ...
  return (
    ...
    <div className="flex-1 flex flex-col items-center justify-center lg:flex-row lg:justify-center mt-30 lg:mt-30"> {/* Added margin-top */}
      <div className="w-full max-w-md p-8 bg-white shadow-md rounded-md m-4 lg:m-0 lg:ml-16">
      ...
      <div className="hidden lg:flex flex-1 justify-center items-center mt-8 lg:mt-0 lg:ml-8">
        <img src={wayConcept} alt="Concept Illustration" className="max-w-full h-auto" />
      </div>
    </div>
    <Footer />
  </div>
