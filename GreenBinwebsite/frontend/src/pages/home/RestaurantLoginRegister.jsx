...
import takeAwayImage from "../../assets/mother.jpeg"; // Import the image
import Footer from "../../components/HomePageCompo/Footer";
import logo from "../../assets/logo.png";

const RestaurantLoginRegister = () => {
  ...
  const handleRegister = async (e) => {
    ...
    try {
      ...
      if (response.data.status) {
        navigate("/ResLogin"); // Navigate to the login page
      }
    ...
    <div className="min-h-screen flex flex-col">
      ...
      <div className="flex-1 flex flex-col items-center justify-center mt-16 lg:flex-row lg:justify-center">
        <div className="w-full max-w-md p-8 bg-white shadow-md rounded-md m-4 lg:m-0 lg:ml-16 mt-4">
          ...
          <form onSubmit={handleRegister}>
            ...
            <div className="mt-4 flex justify-between items-center">
              <p>
                Have an Account?{" "}
                <Link className="text-blue-500" to="/ResLogin">
                  Login
                </Link>
              </p>
            </div>
        ...
        <div
          ...
          style={{
            backgroundImage: `url(${takeAwayImage})`,
...
export default RestaurantLoginRegister;
