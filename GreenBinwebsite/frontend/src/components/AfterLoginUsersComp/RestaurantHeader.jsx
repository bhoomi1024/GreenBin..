...
const RestaurantHeader = () => {
  return (
    <div className='bg-lime-200 h-screen flex items-center overflow-hidden relative'>
      <div className='max-w-7xl mx-auto flex justify-between items-center px-5'>
        <div className='text-left flex-1'>
          ...
          <div className='relative inline-block my-4'>
            <p className='text-5xl font-extrabold text-orange-600 relative transition-transform duration-300 hover:scale-105 animate-fade-in'>
        ...
        <img src={logo}  alt="Delicious Food" className='w-96 h-96 object-cover rounded-full shadow-xl transition-transform duration-300 hover:scale-105' />
        </div>
      </div>
    </div>
  );
